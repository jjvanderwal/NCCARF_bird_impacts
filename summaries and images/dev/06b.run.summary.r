...
suit.table=round(suit.table,digits=2)
...
suit.table=cbind(c('Abundance','Abund. in polygon', 'Abund. outside polygon'),suit.table)

#summary table
summary.table=rbind(area.table,prop.area.table, suit.table)
...
rownames(summary.tidy)=c('total.area','area.in','area.out', 'prop.area','prop.area.in','prop.area.out','abund','abund.in','abund.out','prop.area.lost','prop.in.poly.lost','prop.total.novel','prop.in.poly.novel')
oneline.summary=c(common.name,spp,as.vector(summary.tidy))
oneline.colnames=c('common.name','CLIMID','CURRENT.total.area','CURRENT.area.in','CURRENT.area.out', 'CURRENT.prop.area','CURRENT.prop.area.in','CURRENT.prop.area.out','CURRENT.abund','CURRENT.abund.in','CURRENT.abund.out','CURRENT.prop.area.lost','CURRENT.prop.in.poly.lost','CURRENT.prop.total.novel','CURRENT.prop.in.poly.novel',
'RCP3PD.total.area','RCP3PD.area.in','RCP3PD.area.out', 'RCP3PD.prop.area','RCP3PD.prop.area.in','RCP3PD.prop.area.out','RCP3PD.abund','RCP3PD.abund.in','RCP3PD.abund.out','RCP3PD.prop.area.lost','RCP3PD.prop.in.poly.lost','RCP3PD.prop.total.novel','RCP3PD.prop.in.poly.novel',
'RCP6.total.area','RCP6.area.in','RCP6.area.out', 'RCP6.prop.area','RCP6.prop.area.in','RCP6.prop.area.out','RCP6.abund','RCP6.abund.in','RCP6.abund.out','RCP6.prop.area.lost','RCP6.prop.in.poly.lost','RCP6.prop.total.novel','RCP6.prop.in.poly.novel',
'RCP85.total.area','RCP85.area.in','RCP85.area.out', 'RCP85.prop.area','RCP85.prop.area.in','RCP85.prop.area.out','RCP85.abund','RCP85.abund.in','RCP85.abund.out','RCP85.prop.area.lost','RCP85.prop.in.poly.lost','RCP85.prop.total.novel','RCP85.prop.in.poly.novel')
